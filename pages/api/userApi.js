...
userApi.prototype = {
  ...
  apiURL: {
    ...
    // 用户同意授权
    getuser: '/globals/wsuser/getuser',
    //用户参加活动的信息
 ...
 */
  ...
  */
  getuser: function (args, callback) {
    ...
    that.postURLData(that.apiURL['getuser'], args, callback);
  },
   ...
   * 用户同意授权
   */
  getuser: function (code, encryptedData, iv, avatar, nickname, join_id, callback, args) {
    var that = this;
    args = typeof (args) != 'object' ? {} : args;
    args['code'] = code;
 ...
 *  用户参加活动的信息
 */
  activeInfo: function (uid, callback, args){
    var that = this;
    args = typeof (args) != 'object' ? {} : args;
    args['uid'] = uid;
