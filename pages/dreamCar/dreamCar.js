...
Page({
  ...
  backdraw: function (res) {
    ...
    if (this.data.drawerSeriesData.length){
      wx.hideLoading();
    }
  },
  ...
  carType: function (e) {
    ...
    // console.log(e.currentTarget.dataset.cxid);
    // console.log(e.currentTarget.dataset.ppid);
    ...
    prevPage.setData({
      dreamCar: e.currentTarget.dataset.text + ' ' + e.currentTarget.dataset.name,
      ppid: e.currentTarget.dataset.ppid,
      cxid: e.currentTarget.dataset.cxid,
      carimg: e.currentTarget.dataset.carimg,
      selectCar:false
    }) 
